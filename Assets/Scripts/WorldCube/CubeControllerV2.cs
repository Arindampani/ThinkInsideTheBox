...
namespace WorldCube
{
    public class CubeControllerV2 : MonoBehaviour
    {
        ...
        private bool CheckRotationObstacle()
        {
            //RaycastHit hit;
            //if(Physics.Linecast(Dummy.Instance.transform.position, Vector3.forward * CubeWorld.CUBIE_LENGTH / 2, out hit, CubeWorld.CUBIE_LAYER_MASK)){
            //    return true;
            //}else if(Physics.Linecast(Dummy.Instance.transform.position, Vector3.back * CubeWorld.CUBIE_LENGTH / 2, out hit, CubeWorld.CUBIE_LAYER_MASK))
            //{

            //}
            //else if (Physics.Linecast(Dummy.Instance.transform.position, Vector3.left * CubeWorld.CUBIE_LENGTH / 2, out hit, CubeWorld.CUBIE_LAYER_MASK))
            //{

            //}
            //else if (Physics.Linecast(Dummy.Instance.transform.position, Vector3.right * CubeWorld.CUBIE_LENGTH / 2, out hit, CubeWorld.CUBIE_LAYER_MASK))
            //{
